...
public class adminUI {
	...
	public adminUI() {
		//mngFrame.setIconImage(
				//Toolkit.getDefaultToolkit().getImage("C:\\Users\\msa18\\OneDrive\\Desktop\\?ç†?éàÎºÑÂç†?éå?í≤?ö•?â™ÎÆÜË´≠Ôø? (1).png"));
		...
		seat1.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		seat1.setVerticalAlignment(SwingConstants.TOP);

		seat5.setBackground(Color.WHITE);
		seat5.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat2.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat6.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat3.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat7.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat4.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat8.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat9.setForeground(SystemColor.activeCaption);
		seat9.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat10.setForeground(SystemColor.activeCaption);
		seat10.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat11.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat12.setForeground(SystemColor.activeCaption);
		seat12.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat13.setForeground(SystemColor.activeCaption);
		seat13.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat14.setForeground(SystemColor.activeCaption);
		seat14.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat15.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat16.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat17.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat18.setForeground(SystemColor.activeCaption);
		seat18.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat24.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat19.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat20.setForeground(SystemColor.activeCaption);
		seat20.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat25.setFont(new Font("ÔøΩÎ§ÉÔøΩÔøΩÔøΩÎµù", Font.BOLD, 10));
		...
		seat26.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat27.setForeground(SystemColor.activeCaption);
		seat27.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
...
//      seat21.setOpaque(true);
		...
		seat21.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat28.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat22.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat29.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat23.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		seat30.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 10));
		...
		JButton btnNewButton_1 = new JButton("Ï±ÑÌåÖ");
		btnNewButton_1.setBackground(Color.WHITE);
		btnNewButton_1.setForeground(SystemColor.inactiveCaption);
		btnNewButton_1.setFont(new Font("Íµ¥Î¶º", Font.BOLD, 12));
		...
		String[] header = { "Î©îÎâ¥Î≤àÌò∏","Î©îÎâ¥Î™?","Í∞?Í≤?","Î∂ÑÎ•ò" };

		add_b = new JButton("Ï∂îÍ?");
		add_b.setBounds(30, 310, 97, 34);
		menu_t.add(add_b);
		

		edit_b = new JButton("?àò?†ï");
		edit_b.setBounds(140, 310, 97, 34);
		menu_t.add(edit_b);
		

		del_b = new JButton("?Ç≠?†ú");
		...
		JButton btn = new JButton("Î≤ÑÌäº");
		...
		JLabel lblNewLabel = new JLabel("Î©îÎâ¥Î™?");
		lblNewLabel.setBounds(27, 38, 45, 28);
		panel.add(lblNewLabel);
		lblNewLabel.setFont(new Font("KoPubWorld?èã??Ï≤? Medium", Font.PLAIN, 13));
		...
		JLabel lblPrice = new JLabel("Í∞?Í≤?");
		lblPrice.setBounds(27, 100, 45, 28);
		panel.add(lblPrice);
		lblPrice.setFont(new Font("KoPubWorld?èã??Ï≤? Medium", Font.PLAIN, 13));
		...
		JLabel lblPrice_1 = new JLabel("?ù¥ÎØ∏Ï?");
		lblPrice_1.setBounds(27, 165, 45, 28);
		panel.add(lblPrice_1);
		lblPrice_1.setFont(new Font("KoPubWorld?èã??Ï≤? Medium", Font.PLAIN, 13));
		...
		JLabel lblPrice_1_1 = new JLabel("Î©îÎâ¥Î≤àÌò∏");
		lblPrice_1_1.setBounds(27, 38, 45, 28);
		panel_1.add(lblPrice_1_1);
		lblPrice_1_1.setFont(new Font("KoPubWorld?èã??Ï≤? Medium", Font.PLAIN, 13));
