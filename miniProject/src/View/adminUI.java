...
public class adminUI {
	...
	public adminUI() {
		//mngFrame.setIconImage(
				//Toolkit.getDefaultToolkit().getImage("C:\\Users\\msa18\\OneDrive\\Desktop\\?��?��뼄占?��?��?��?��뮆諭�? (1).png"));
...
//      seat21.setOpaque(true);
		...
		lblNewLabel.setFont(new Font("KoPubWorld?��??�? Medium", Font.PLAIN, 13));
		...
		panel.add(lblPrice);
		lblPrice.setFont(new Font("KoPubWorld?��??�? Medium", Font.PLAIN, 13));
		...
		JLabel lblPrice_1 = new JLabel("?��미�?");
		lblPrice_1.setBounds(27, 165, 45, 28);
		panel.add(lblPrice_1);
		lblPrice_1.setFont(new Font("KoPubWorld?��??�? Medium", Font.PLAIN, 13));
		...
		lblPrice_1_1.setFont(new Font("KoPubWorld?��??�? Medium", Font.PLAIN, 13));
